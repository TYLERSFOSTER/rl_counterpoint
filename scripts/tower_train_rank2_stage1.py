"""Explicit rank-2 stage-1 training entrypoint for staged curricula."""
...
from tower.train.runner import TowerRunnerConfig, run_rank2_training
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        archived_stage1_rank_dir = result.paths.lineage_dir / "rank_2_stage1"
